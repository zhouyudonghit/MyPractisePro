...
public class ShaderTest extends BaseTest {
    ...
    {
        Shader shader = new LinearGradient(200,100,400,100,Color.parseColor("#E91E63"),
    ...
    {
        Shader shader = new RadialGradient(mViewWidth/2,mViewHeight/4,mViewHeight/4,Color.parseColor("#E91E63"),
    ...
    public void testShader4(Canvas canvas, Context context)
    {
        ...
        mPaint.setShader(shader);
        //canvas.drawCircle(mViewWidth/2,mViewHeight/2,mViewHeight/4,mPaint);
        canvas.drawRect(0,0,mViewWidth/4,mViewHeight/4,mPaint);
    }
}
