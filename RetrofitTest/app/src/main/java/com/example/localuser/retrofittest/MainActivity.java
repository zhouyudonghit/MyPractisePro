...
import com.example.localuser.retrofittest.MatrixTest.MatrixTestActivity;
...
import com.example.localuser.retrofittest.SVGATest.SVGATestActivity;
...
//                startActivity(new Intent(MainActivity.this, StepCounterTestActivity.class));
        ...
        tv50 = findViewById(R.id.maskview_test_activity);
        tv50.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, MaskViewTestActivity.class));
            }
        });

        tv51 = findViewById(R.id.matrix_test_activity);
        ...
        tv52 = findViewById(R.id.address_picker_test_activity);
        ...
        tv59 = findViewById(R.id.svga__test_activity);
