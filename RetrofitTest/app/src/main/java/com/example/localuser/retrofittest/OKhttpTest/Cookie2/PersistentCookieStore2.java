package com.example.localuser.retrofittest.OKhttpTest.Cookie2;
...
public class PersistentCookieStore2 implements CookieStore {
    ...
    public void add(HttpUrl httpUrl, Cookie cookie) {
        //cookie.persistent是session级别的cookie，理论上是浏览器关闭的时候要删除的，没必要本地持久化，
        //但是对于安卓应用来说，session的概念是很模糊的，像苏宁的app，不管是否设置了过期时间，都本地化存储了。
